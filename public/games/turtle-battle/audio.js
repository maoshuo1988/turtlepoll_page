...
// Preload SFX files
_loadSfx('hit-physical', '/games/turtle-battle/assets/sfx/hit-physical.wav');
_loadSfx('hit-crit', '/games/turtle-battle/assets/sfx/hit-crit.wav');
_loadSfx('shield-gain', '/games/turtle-battle/assets/sfx/shield-gain.wav');
_loadSfx('shield-break', '/games/turtle-battle/assets/sfx/shield-break.wav');
_loadSfx('heal', '/games/turtle-battle/assets/sfx/heal.wav');
_loadSfx('defeat', '/games/turtle-battle/assets/sfx/defeat.wav');
_loadSfx('rebirth', '/games/turtle-battle/assets/sfx/rebirth.wav');
...
const BGM_TRACKS = {
  menu: '/games/turtle-battle/assets/bgm-menu.mp3',
  battle: '/games/turtle-battle/assets/bgm-battle.mp3',
  boss: '/games/turtle-battle/assets/bgm-boss.mp3'
};
