...
import * as Plugin_0 from '/Users/wangheng/Documents/PolyMarket/forum/turtle_project/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/wangheng/Documents/PolyMarket/forum/turtle_project/src/app.ts',
    },
    {
      apply: Plugin_1,
