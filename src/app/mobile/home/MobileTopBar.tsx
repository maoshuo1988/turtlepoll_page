      ...
      <header className={`fixed left-0 right-0 top-0 z-50 backdrop-blur-xl xl:hidden ${darkMode ? 'border-b border-white/8 bg-[#090909]/92' : 'border-b border-slate-200 bg-white/92'}`}>
        <div className="flex h-[58px] items-center gap-3 px-3">
          <div className="flex shrink-0 items-center gap-2">
            <div className={`grid h-8 w-8 place-items-center overflow-hidden rounded-xl border shadow-[0_8px_20px_rgba(0,0,0,0.18)] ${darkMode ? 'border-white/10 bg-gradient-to-br from-[#1a1a1d] to-[#0d0d10]' : 'border-slate-200 bg-gradient-to-br from-[#f6fff8] to-[#ecf2ee]'}`}>
