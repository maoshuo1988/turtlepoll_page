...
const STEPS: GuideStep[] = [
  ...
  },
  {
    icon: '⚔️',
    title: '龟势 PK',
    desc: '在龟龟对战进入战场，和其他玩家正面交锋。选择阵营，押注龟币、赢取荣耀！',
  },
  {
    icon: '🥚',
    title: '收集宠物',
  ...
  return (
    <div className="fixed inset-0 z-[80]">
      ...
      <div className="absolute inset-0 grid place-items-center !p-4">
        <div
          className="w-full max-w-[420px] rounded-[24px] border border-slate-200 bg-white !px-8 !py-7 shadow-[0_24px_70px_rgba(0,0,0,0.28)] dark:border-rdark-border dark:bg-rdark-card"
        ...
        >
          ...
          <div className="text-center">
            ...
            <h3 className="!mt-4 text-[28px] font-black leading-tight text-emerald-500">{current.title}</h3>
          ...
          <div className="!mt-7 flex items-center justify-center gap-10">
            <button
              className="h-11 min-w-[88px] cursor-pointer rounded-[12px] border border-slate-300 bg-white text-[15px] font-bold text-slate-500 dark:border-rdark-border dark:bg-rdark-input dark:text-rdark-text2"
              onClick={onClose}
            >
              跳过
            </button>
            <button
              className="h-11 min-w-[104px] cursor-pointer rounded-[12px] border-0 bg-gradient-to-r from-emerald-500 to-cyan-500 text-[15px] font-bold text-white"
